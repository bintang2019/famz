...
║ ◄━━◈⟦Famz___Botz⟧◈━━►
║𖤓≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛≛𖤓
║https://line.me/ti/p/Q4WzTBxIVO
╚═══════════════"""

MVps ="""╔═══════𖤓Ready𖤓════════
║𖤓Price VPS Gooogle Cloud𖤓
╠[★]1 Core 1GB RAM 150k/Bulan
╠[★]1 Core 2GB RAM 3000k/Bulan
╠[★]2 Core 2GB RAM 400k/Bulan
╠[★]2 Core 4GB RAM 500k/Bulan
║
║Pembayaran Via :
╠[★]Bank BNI
╚════════════════════"""
...
Mbni ="""╔═════𖤓My Rekening𖤓══════
║BNI
║No Rekening : 0268601359
║Atas Nama : Bardiansyah
║
║BRI
║No Rekening : 5659-01-027824-53-2
║Atas Nama : Bardiansyah
║
║Hp/Wa : 082279487483
╚══════════════════"""
...
║→Indonesia←
╠[★]Registrasi 300K
╠[★]Bulan Selanjutnya 200K/Bulan
║
║𖤓Bot SB Only𖤓
╠[★]75k/bulan
║
║Total Bots → 10 Bots + 1 ghost +1 Antijs +1 sb
...
OWNER=["u207280ad8ec168e15de1da1246675fd3"] #Mardudo
admin=["u207280ad8ec168e15de1da1246675fd3"] #Mardudo
  
staff=[
  "ueaa49bb6935bc1a965b387ac0ab69f2c"] #Arie
#================
msg_dict = {}
cctv = {
    "cyduk":{},
                    ...
                    if text is None:
                        ...
                        if msg.text in ["Absen","Absen bot","Absen dulu","Respon"]:
                         if msg._from in admin:
                          k1.sendMessage(msg.to,"◄━━◈⟦Bardi_Famz⟧◈━━►")
                        ...
                        elif msg.text in ["My bank","my bank"]:
                         if msg._from in OWNER:
                           if wait["lang"] == "JP":
                              k1.sendMessage(msg.to,Mbni)
                           else:
                              k1.sendMessage(msg.to,Mbni)
                              
                        elif msg.text in ["Vps","price vps"]:
                         if msg._from in OWNER:
                           if wait["lang"] == "JP":
...
#======================================
                        ...
                        #    k10.leaveGroup(msg.to)
                          ...
                          if sender in admin:
                            start = time.time()
                            k1.sendMessage(to, "Tak Hitung Dulu Boss...")
                            elapsed_time = time.time() - start
...
#==============================================================================#
                          ...
                          if sender in OWNER:
                            ...
                            k1.sendMessage(to, "☝️☝️☝️Atas______Ganteng 👍👍👍")
                            k1.sendMessage(to, "👇👇👇Bawah Gw________Jelek🤣🤣🤣")
                        elif koplaxs == "mybots":
                          if sender in OWNER:
                            k1.sendMessage(to,"┣━━╦━━━━━━━━━━━╦━━╣")
...
#========================#
                        ...
                        elif koplaxs.startswith("Sholat "):
                          if sender in admin:
                            separate = msg.text.split(" ")
...
#===========================#
 ...
 #============== TEST CCTV DAN SIDER =========================
                          ...
                          if sender in admin:
                            ...
                            wait["Sider"] = False
                            k1.sendMessage(msg.to,"Siap Nangkap yang ngintip")
...
#=====================================#
                          ...
                          if sender in OWNER:
                            ...
                            groups = k1.groups
                            for group in groups:
                                sendMessageWithFooter(group, "╭━━━━━╦BroadCast by F1 FAMILY FAMZ╦━━━━━╮\n{}".format(str(txt)))
                          ...
                          if op.param2 in OWNER:
                            ...
                            if Name in cctv['sidermem'][op.param1]:
                                ...
                                if " " in Name:
                                    nick = Name.split(' ')
                                    if len(nick) == 2:
                                        k1.sendMessage(op.param1, "Lagi Ngapain " + "☞ " + Name + " ☜" + " stalking ya...!!! masuk sini hehehe")
                                       # k1.sendImageWithURL(op.param1, "http://dl.profile.line-cdn.net/" + Np)
                                        #mentionMembers(to, [Kontol])
                                    else:
                                        k1.sendMessage(op.param1, "Hai " + "☞ " + Name + " ☜" + " Keciduk Loe...! Sini Gabung  biar rame...!!!")
                                        #k1.sendImageWithURL(op.param1, "http://dl.profile.line-cdn.net/" + Np)
                                        #mentionMembers(to, [Kontol])
                                else:
                                    k1.sendMessage(op.param1, "Kami semua tau lho " + "☞ " + Name + " ☜" + " kalo kamu ngintip...!!! masuk sini udah ditunggu sama tikungan")
                                    #k1.sendImageWithURL(op.param1, "http://dl.profile.line-cdn.net/" + Np)
                                    #mentionMembers(to, [Kontol])
                        else:
                            pass
        ...
        if op.type == 26:
          ...
          if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["detectMention"] == True: 
                    ...
                    balas = [cName + " 👉👉 Apaan tag2...!!! Penting PC aja Langsung"]
                    balas = ["Hadirrrrr👉 "+k1.getProfile().displayName+"👈Mau Ngasih Coin yaa.. banyakin dong.."]
                    balas = [cName + " 👉👉 Kalo ngajak kojom PM aja...!!!!"]
                    #path = "http://dl.profile.line-cdn.net/" + contact.pictureStatus                
